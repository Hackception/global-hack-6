exports.calculateWeight = function(key) {
    ...
    ref.once('value', function(snapshot) {
        ...
        if ((responses['forceOrTrick'] || {}).answer ||
            ...
            (responses['sleepLocation'] && (responses['sleepLocation'].answer !== 'shelter'))) {
            weight++;
        }

        if ((responses['oweMoney'] || {}).answer ||
            (responses['moneyIncome'] && !responses['moneyIncome'].answer) ||
            (responses['meetExpenses'] && !responses['meetExpenses'].answer)) {
            weight++;
        }

        if ((responses['plannedActivities'] && !responses['plannedActivities'].answer)) {
            weight++;
        }
